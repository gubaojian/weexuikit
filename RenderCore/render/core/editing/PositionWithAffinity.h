...
#ifndef WEEX_UIKIT_CORE_EDITING_POSITIONWITHAFFINITY_H_
#define WEEX_UIKIT_CORE_EDITING_POSITIONWITHAFFINITY_H_
...
#endif  // WEEX_UIKIT_CORE_EDITING_POSITIONWITHAFFINITY_H_
