...
#ifndef WEEX_UIKIT_CORE_RENDERING_HITTESTLOCATION_H_
#define WEEX_UIKIT_CORE_RENDERING_HITTESTLOCATION_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_HITTESTLOCATION_H_
