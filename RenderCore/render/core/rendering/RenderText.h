...
#ifndef WEEX_UIKIT_CORE_RENDERING_RENDERTEXT_H_
#define WEEX_UIKIT_CORE_RENDERING_RENDERTEXT_H_
...
class RenderText : public RenderObject {
 public:
  ...
  virtual bool nodeAtPoint(const HitTestRequest& request,
                           HitTestResult& result,
                           const HitTestLocation& location,
                           const LayoutPoint& point) override final {
    return RenderObject::nodeAtPoint(request, result, location, point);
  }
...
#endif  // WEEX_UIKIT_CORE_RENDERING_RENDERTEXT_H_
