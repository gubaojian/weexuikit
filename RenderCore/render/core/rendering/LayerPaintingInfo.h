...
#ifndef WEEX_UIKIT_CORE_RENDERING_LAYERPAINTINGINFO_H_
#define WEEX_UIKIT_CORE_RENDERING_LAYERPAINTINGINFO_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_LAYERPAINTINGINFO_H_
