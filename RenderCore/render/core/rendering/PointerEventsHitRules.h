...
#ifndef WEEX_UIKIT_CORE_RENDERING_POINTEREVENTSHITRULES_H_
#define WEEX_UIKIT_CORE_RENDERING_POINTEREVENTSHITRULES_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_POINTEREVENTSHITRULES_H_
