...
#include "render/core/editing/CompositionUnderlineRangeFilter.h"
...
#include "render/platform/animation/UnitBezier.h"
#include "render/platform/fonts/FontCache.h"
#include "render/platform/fonts/GlyphBuffer.h"
#include "render/platform/fonts/WidthIterator.h"
...
bool InlineTextBox::nodeAtPoint(const HitTestRequest& request,
  ...
  if (m_truncation != cFullTruncation && visibleToHitTestRequest(request) &&
    ...
    if(renderer().nodeAtPoint(request, result, locationInContainer, accumulatedOffset)){
