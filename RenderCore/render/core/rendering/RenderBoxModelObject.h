...
#ifndef WEEX_UIKIT_CORE_RENDERING_RENDERBOXMODELOBJECT_H_
#define WEEX_UIKIT_CORE_RENDERING_RENDERBOXMODELOBJECT_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_RENDERBOXMODELOBJECT_H_
