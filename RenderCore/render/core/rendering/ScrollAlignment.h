...
#ifndef WEEX_UIKIT_CORE_RENDERING_SCROLLALIGNMENT_H_
#define WEEX_UIKIT_CORE_RENDERING_SCROLLALIGNMENT_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_SCROLLALIGNMENT_H_
