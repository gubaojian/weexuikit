...
#ifndef WEEX_UIKIT_CORE_RENDERING_INLINEITERATOR_H_
#define WEEX_UIKIT_CORE_RENDERING_INLINEITERATOR_H_

#include "render/core/rendering/BidiRun.h"
...
#endif  // WEEX_UIKIT_CORE_RENDERING_INLINEITERATOR_H_
