...
#ifndef WEEX_UIKIT_CORE_RENDERING_RENDERPARAGRAPH_H_
#define WEEX_UIKIT_CORE_RENDERING_RENDERPARAGRAPH_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_RENDERPARAGRAPH_H_
