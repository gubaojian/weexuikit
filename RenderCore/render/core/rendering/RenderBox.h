...
#ifndef WEEX_UIKIT_CORE_RENDERING_RENDERBOX_H_
#define WEEX_UIKIT_CORE_RENDERING_RENDERBOX_H_

#include "render/core/rendering/RenderBoxModelObject.h"
#include "render/core/rendering/RenderOverflow.h"
...
class RenderBox : public RenderBoxModelObject {
 public:
  ...
  virtual void paintLayer(GraphicsContext*, const LayerPaintingInfo&);

  virtual void paintLayerContents(GraphicsContext*, const LayerPaintingInfo&);
...
#endif  // WEEX_UIKIT_CORE_RENDERING_RENDERBOX_H_
