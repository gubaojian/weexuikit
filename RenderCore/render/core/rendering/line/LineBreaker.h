...
#ifndef WEEX_UIKIT_CORE_RENDERING_LINE_LINEBREAKER_H_
#define WEEX_UIKIT_CORE_RENDERING_LINE_LINEBREAKER_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_LINE_LINEBREAKER_H_
