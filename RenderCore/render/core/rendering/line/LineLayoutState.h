...
#ifndef WEEX_UIKIT_CORE_RENDERING_LINE_LINELAYOUTSTATE_H_
#define WEEX_UIKIT_CORE_RENDERING_LINE_LINELAYOUTSTATE_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_LINE_LINELAYOUTSTATE_H_
