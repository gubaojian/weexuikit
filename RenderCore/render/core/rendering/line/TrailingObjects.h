...
#ifndef WEEX_UIKIT_CORE_RENDERING_LINE_TRAILINGOBJECTS_H_
#define WEEX_UIKIT_CORE_RENDERING_LINE_TRAILINGOBJECTS_H_
...
class TrailingObjects {
 public:
  TrailingObjects() : m_whitespace(0) {}
...
#endif  // WEEX_UIKIT_CORE_RENDERING_LINE_TRAILINGOBJECTS_H_
