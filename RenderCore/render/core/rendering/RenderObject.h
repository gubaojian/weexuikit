...
#ifndef WEEX_UIKIT_CORE_RENDERING_RENDEROBJECT_H_
#define WEEX_UIKIT_CORE_RENDERING_RENDEROBJECT_H_

#include <render/core/node/Node.h>
#include "render/core/editing/PositionWithAffinity.h"
#include "render/core/rendering/HitTestRequest.h"
#include "render/core/rendering/RenderObjectChildList.h"
...
public:
    void onPointerEvent(weexuikit::PointerEvent &pointerEvent){
        if(mPointerEventListener != nullptr){
            mPointerEventListener->onPointerEvent(pointerEvent);
        }
    }
    
public:
    weexuikit::PointerEventListener*  mPointerEventListener;
 ...
 public:
  ...
  bool isOutOfFlowPositioned() const {
    ...
    bool isInFlowPositioned() const { return m_bitfields.isRelPositioned();}
 ...
 bool isRelPositioned() const { return m_bitfields.isRelPositioned(); } // relative positioning
  ...
  RenderObject* offsetParentRenderObject() const;
...
#define ADD_BOOLEAN_BITFIELD(name, Name) \
 ...
 public:                                 \
  ...
  class RenderObjectBitfields {
   ...
   public:
    RenderObjectBitfields()
        : m_selfNeedsLayout(false),
          ...
          m_positionedState(EPosition::StaticPosition),
   ...
   public:
    bool isOutOfFlowPositioned() const {
      return m_positionedState == EPosition::AbsolutePosition;
    }

    bool isRelPositioned() const { return m_positionedState == EPosition::RelativePosition; }


    bool isPositioned() const {
      return m_positionedState != EPosition::StaticPosition;
    }

    void setPositionedState(EPosition positionState) {
      m_positionedState = positionState;
    }
...
#undef ADD_BOOLEAN_BITFIELD
 ...
 public:
       weexuikit::Node* getNode() const{
         return node;
       }
       inline void setNode(weexuikit::Node* node_){
           this->node = node_;
       }
 ...
 private:
        ...
        static bool isParentAriaHidden(RenderObject *renderObject);
    };
...
#endif  // WEEX_UIKIT_CORE_RENDERING_RENDEROBJECT_H_
