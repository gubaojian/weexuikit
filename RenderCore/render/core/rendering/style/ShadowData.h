...
#ifndef WEEX_UIKIT_CORE_RENDERING_STYLE_SHADOWDATA_H_
#define WEEX_UIKIT_CORE_RENDERING_STYLE_SHADOWDATA_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_STYLE_SHADOWDATA_H_
