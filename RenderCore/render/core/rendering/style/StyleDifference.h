...
#ifndef WEEX_UIKIT_CORE_RENDERING_STYLE_STYLEDIFFERENCE_H_
#define WEEX_UIKIT_CORE_RENDERING_STYLE_STYLEDIFFERENCE_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_STYLE_STYLEDIFFERENCE_H_
