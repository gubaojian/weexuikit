...
#ifndef WEEX_UIKIT_CORE_RENDERING_STYLE_COUNTERDIRECTIVES_H_
#define WEEX_UIKIT_CORE_RENDERING_STYLE_COUNTERDIRECTIVES_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_STYLE_COUNTERDIRECTIVES_H_
