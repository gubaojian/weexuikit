...
#ifndef WEEX_UIKIT_CORE_RENDERING_STYLE_APPLIEDTEXTDECORATION_H_
#define WEEX_UIKIT_CORE_RENDERING_STYLE_APPLIEDTEXTDECORATION_H_
...
#endif  // WEEX_UIKIT_CORE_RENDERING_STYLE_APPLIEDTEXTDECORATION_H_
