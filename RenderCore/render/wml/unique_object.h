...
#ifndef WEEX_UIKIT_WML_UNIQUE_OBJECT_H_
#define WEEX_UIKIT_WML_UNIQUE_OBJECT_H_
...
class UniqueObject {
 ...
 public:
  ...
  void reset(const T& value = Traits::InvalidValue()) {
    WML_CHECK(data_.generic == Traits::InvalidValue() ||
              data_.generic != value);
    FreeIfNecessary();
    data_.generic = value;
  }
  ...
  T release() WML_WARN_UNUSED_RESULT {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(UniqueObject);
};
...
#endif  // WEEX_UIKIT_WML_UNIQUE_OBJECT_H_
