...
#ifndef WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_BLOCK_H_
#define WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_BLOCK_H_
...
class ScopedBlock {
 public:
  ...
  B release() WML_WARN_UNUSED_RESULT {
    B temp = block_;
    block_ = nullptr;
    return temp;
  }
...
#endif  // WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_BLOCK_H_
