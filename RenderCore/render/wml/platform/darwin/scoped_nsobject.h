...
#ifndef WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_NSOBJECT_H_
#define WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_NSOBJECT_H_
...
#include "wml/compiler_specific.h"
...
class scoped_nsprotocol {
 public:
  ...
  NST release() WML_WARN_UNUSED_RESULT {
    NST temp = object_;
    object_ = nil;
    return temp;
  }
...
class scoped_nsobject<NSAutoreleasePool> {
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(scoped_nsobject);
};

}  // namespace wml

#endif  // WEEX_UIKIT_WML_PLATFORM_DARWIN_SCOPED_NSOBJECT_H_
