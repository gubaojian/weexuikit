...
#ifndef WEEX_UIKIT_WML_PLATFORM_LINUX_TIMER_FD_H_
#define WEEX_UIKIT_WML_PLATFORM_LINUX_TIMER_FD_H_
...
#define WML_TIMERFD_AVAILABLE 1

#else  // __has_include(<sys/timerfd.h>)

#define WML_TIMERFD_AVAILABLE 0
...
bool TimerRearm(int fd, wml::TimePoint time_point);
...
#endif  // WEEX_UIKIT_WML_PLATFORM_LINUX_TIMER_FD_H_
