...
#ifndef WEEX_UIKIT_WML_TRACE_EVENT_H_
#define WEEX_UIKIT_WML_TRACE_EVENT_H_
...
#define TRACE_EVENT0(category_group, name)           \
  ::wml::tracing::TraceEvent0(category_group, name); \
  ::wml::tracing::ScopedInstantEnd __trace_end0_##__LINE__(name);

#define TRACE_EVENT1(category_group, name, arg1_name, arg1_val)           \
  ::wml::tracing::TraceEvent1(category_group, name, arg1_name, arg1_val); \
  ::wml::tracing::ScopedInstantEnd __trace_end1_##__LINE__(name);

#define TRACE_EVENT2(category_group, name, arg1_name, arg1_val, arg2_name, \
                     arg2_val)                                             \
  ::wml::tracing::TraceEvent2(category_group, name, arg1_name, arg1_val,   \
                              arg2_name, arg2_val);                        \
  ::wml::tracing::ScopedInstantEnd __trace_end2_##__LINE__(name);

#define TRACE_EVENT_ASYNC_BEGIN0(category_group, name, id) \
  ::wml::tracing::TraceEventAsyncBegin0(category_group, name, id);

#define TRACE_EVENT_ASYNC_END0(category_group, name, id) \
  ::wml::tracing::TraceEventAsyncEnd0(category_group, name, id);

#define TRACE_EVENT_ASYNC_BEGIN1(category_group, name, id, arg1_name,        \
                                 arg1_val)                                   \
  ::wml::tracing::TraceEventAsyncBegin1(category_group, name, id, arg1_name, \
                                        arg1_val);

#define TRACE_EVENT_ASYNC_END1(category_group, name, id, arg1_name, arg1_val) \
  ::wml::tracing::TraceEventAsyncEnd1(category_group, name, id, arg1_name,    \
                                      arg1_val);

#define TRACE_EVENT_INSTANT0(category_group, name) \
  ::wml::tracing::TraceEventInstant0(category_group, name);

#define TRACE_FLOW_BEGIN(category, name, id) \
  ::wml::tracing::TraceEventFlowBegin0(category, name, id);

#define TRACE_FLOW_STEP(category, name, id) \
  ::wml::tracing::TraceEventFlowStep0(category, name, id);

#define TRACE_FLOW_END(category, name, id) \
  ::wml::tracing::TraceEventFlowEnd0(category, name, id);
...
class ScopedInstantEnd {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(ScopedInstantEnd);
};

}  // namespace tracing
}  // namespace wml

#endif  // WEEX_UIKIT_WML_TRACE_EVENT_H_
