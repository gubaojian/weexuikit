...
#ifndef WEEX_UIKIT_WML_MAKE_COPYABLE_H_
#define WEEX_UIKIT_WML_MAKE_COPYABLE_H_
...
//     wml::MakeCopyable([bar = std::move(foo)]() { return bar->count(); });
//
...
#endif  // WEEX_UIKIT_WML_MAKE_COPYABLE_H_
