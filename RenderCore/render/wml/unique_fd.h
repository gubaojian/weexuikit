...
#ifndef WEEX_UIKIT_WML_UNIQUE_FD_H_
#define WEEX_UIKIT_WML_UNIQUE_FD_H_
...
using UniqueFD = UniqueObject<int, internal::unixFD::UniqueFDTraits>;

#endif  // OS_WIN

}  // namespace wml

#endif  // WEEX_UIKIT_WML_UNIQUE_FD_H_
