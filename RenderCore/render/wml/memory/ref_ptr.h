...
#ifndef WEEX_UIKIT_WML_MEMORY_REF_PTR_H_
#define WEEX_UIKIT_WML_MEMORY_REF_PTR_H_
...
#include "wml/memory/ref_ptr_internal.h"
...
class RefPtr final {
 ...
 private:
  ...
  enum AdoptTag { ADOPT };
  RefPtr(T* ptr, AdoptTag) : ptr_(ptr) { WML_DCHECK_(ptr_); }
...
namespace std {
template <typename T>
struct hash<wml::RefPtr<T>> {
  using argument_type = wml::RefPtr<T>;
...
#endif  // WEEX_UIKIT_WML_MEMORY_REF_PTR_H_
