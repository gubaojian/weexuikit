...
#ifndef WEEX_UIKIT_WML_MEMORY_REF_COUNTED_H_
#define WEEX_UIKIT_WML_MEMORY_REF_COUNTED_H_

#include "wml/macros.h"
#include "wml/memory/ref_counted_internal.h"
...
// |RefCountedThreadSafe<Foo>|; use |WML_FRIEND_REF_COUNTED_THREAD_SAFE()|
// for this:
//
//   class Foo : public RefCountedThreadSafe<Foo> {
//     ...
//    private:
//     WML_FRIEND_REF_COUNTED_THREAD_SAFE(Foo);
//     ~Foo();
//     ...
//   };
//
...
// |WML_FRIEND_MAKE_REF_COUNTED()|:
//
//   class Foo : public RefCountedThreadSafe<Foo> {
//     ...
//    private:
//     WML_FRIEND_MAKE_REF_COUNTED(Foo);
//     Foo();
...
class RefCountedThreadSafe : public internal::RefCountedThreadSafeBase {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(RefCountedThreadSafe);
};
...
#define WML_FRIEND_REF_COUNTED_THREAD_SAFE(T) \
  friend class ::wml::RefCountedThreadSafe<T>

// If you want to keep your constructor(s) private and still want to use
// |MakeRefCounted<T>()|, use this. (See the example above
// |RefCountedThreadSafe|.)
#define WML_FRIEND_MAKE_REF_COUNTED(T) \
  friend class ::wml::internal::MakeRefCountedHelper<T>

}  // namespace wml

#endif  // WEEX_UIKIT_WML_MEMORY_REF_COUNTED_H_
