...
#ifndef WEEX_UIKIT_WML_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define WEEX_UIKIT_WML_SYNCHRONIZATION_WAITABLE_EVENT_H_

#include <condition_variable>
#include <mutex>

#include "wml/macros.h"
#include "wml/synchronization/thread_annotations.h"
#include "wml/time/time_delta.h"
...
class AutoResetWaitableEvent final {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(AutoResetWaitableEvent);
};
...
class ManualResetWaitableEvent final {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(ManualResetWaitableEvent);
};

}  // namespace wml

#endif  // WEEX_UIKIT_WML_SYNCHRONIZATION_WAITABLE_EVENT_H_
