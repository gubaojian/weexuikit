...
#ifndef WEEX_UIKIT_WML_SYNCHRONIZATION_THREAD_CHECKER_H_
#define WEEX_UIKIT_WML_SYNCHRONIZATION_THREAD_CHECKER_H_
...
class ThreadChecker final {
 ...
 private:
  ...
  WML_DISALLOW_COPY_AND_ASSIGN(ThreadChecker);
};
...
#endif  // WEEX_UIKIT_WML_SYNCHRONIZATION_THREAD_CHECKER_H_
