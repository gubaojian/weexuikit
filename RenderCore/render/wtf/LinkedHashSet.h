...
#ifndef WEEX_UIKIT_WTF_LINKEDHASHSET_H_
#define WEEX_UIKIT_WTF_LINKEDHASHSET_H_

#include "render/wtf/DefaultAllocator.h"
...
class LinkedHashSet {
 ...
 public:
  ...
  AddResult insertBefore(iterator it, ValuePeekInType newValue) {
    return m_impl.template add<NodeHashFunctions>(newValue, it.node());
  }
...
#endif  // WEEX_UIKIT_WTF_LINKEDHASHSET_H_
