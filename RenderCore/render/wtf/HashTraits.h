...
#ifndef WEEX_UIKIT_WTF_HASHTRAITS_H_
#define WEEX_UIKIT_WTF_HASHTRAITS_H_
...
struct GenericHashTraits : GenericHashTraitsBase<IsInteger<T>::value, T> {
  ...
  // Type for return value of functions that do not transfer ownership, such as
  // get.
...
struct HashTraits<OwnPtr<P>> : SimpleClassHashTraits<OwnPtr<P>> {
  ...
  static void store(PassOwnPtr<P> value, OwnPtr<P>& storage) {
    storage = value;
  }
...
#endif  // WEEX_UIKIT_WTF_HASHTRAITS_H_
