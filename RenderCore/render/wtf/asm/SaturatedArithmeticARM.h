...
#ifndef WEEX_UIKIT_WTF_ASM_SATURATEDARITHMETICARM_H_
#define WEEX_UIKIT_WTF_ASM_SATURATEDARITHMETICARM_H_
...
#endif  // WEEX_UIKIT_WTF_ASM_SATURATEDARITHMETICARM_H_
