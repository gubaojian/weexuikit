...
#ifndef WEEX_UIKIT_WTF_TEXT_ATOMICSTRING_H_
#define WEEX_UIKIT_WTF_TEXT_ATOMICSTRING_H_
...
#include "render/wtf/text/StringConcatenate.h"
#endif  // WEEX_UIKIT_WTF_TEXT_ATOMICSTRING_H_
