...
#ifndef WEEX_UIKIT_WTF_TEXT_INTEGERTOSTRINGCONVERSION_H_
#define WEEX_UIKIT_WTF_TEXT_INTEGERTOSTRINGCONVERSION_H_
...
#endif  // WEEX_UIKIT_WTF_TEXT_INTEGERTOSTRINGCONVERSION_H_
