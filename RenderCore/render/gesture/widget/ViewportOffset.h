...
#ifndef WEEX_UIKIT_GESTURE_VIEWPORTOFFSET_H
#define WEEX_UIKIT_GESTURE_VIEWPORTOFFSET_H
#include <algorithm>
#include "../foundation/ChangeNotifier.h"
...
/// [ScrollDirection.idle].
    inline ScrollDirection flipScrollDirection(ScrollDirection direction) {
        switch (direction) {
...
///    offsets.
    ...
    public:
        ...
        /// correction.
        static _FixedViewportOffset fixed(double value);
        /// Creates a viewport offset with a [pixels] value of 0.0.
        ///
        /// The [pixels] value does not change unless the viewport issues a
        /// correction.
        static _FixedViewportOffset zero();
        */
        ...
        /// be laid out again.)
        virtual bool applyViewportDimension(double viewportDimension)=0;
        ...
        virtual bool applyContentDimensions(double minScrollExtent, double maxScrollExtent)=0;
        ...
        virtual void correctBy(double correction)=0;
        ...
        virtual void jumpTo(double pixels)=0;
        ...
        virtual void animateTo(double to, int64_t duration, Curve &curve)=0;
        ...
        /// offset direction.
        virtual ScrollDirection userScrollDirection()=0;
        ...
        virtual bool allowImplicitScrolling()=0;

    };
}


#endif //WEEX_UIKIT_GESTURE_VIEWPORTOFFSET_H
