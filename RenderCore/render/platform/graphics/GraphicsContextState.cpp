...
GraphicsContextState::GraphicsContextState()
  ...
  m_strokePaint.setFilterQuality(
      WebCoreInterpolationQualityToSkFilterQuality(m_interpolationQuality));
  m_strokePaint.setAntiAlias(m_shouldAntialias);
  m_fillPaint.setColor(applyAlpha(m_fillColor.rgb()));
  m_fillPaint.setFilterQuality(
      WebCoreInterpolationQualityToSkFilterQuality(m_interpolationQuality));
...
void GraphicsContextState::setStrokeGradient(
    const PassRefPtr<Gradient> gradient) {
...
void GraphicsContextState::setFillGradient(
    const PassRefPtr<Gradient> gradient) {
  m_fillColor = Color::black;
  m_fillPattern.clear();
...
void GraphicsContextState::setCompositeOperation(
    CompositeOperator compositeOperation,
    WebBlendMode blendMode) {
  m_compositeOperator = compositeOperation;
  m_blendMode = blendMode;
  SkBlendMode skiaBlendMode =
      WebCoreCompositeToSkiaComposite(compositeOperation, blendMode);
...
void GraphicsContextState::setInterpolationQuality(
  ...
  m_strokePaint.setFilterQuality(
      WebCoreInterpolationQualityToSkFilterQuality(quality));
  m_fillPaint.setFilterQuality(
      WebCoreInterpolationQualityToSkFilterQuality(quality));
}
