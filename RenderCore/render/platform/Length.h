...
#ifndef WEEX_UIKIT_PLATFORM_LENGTH_H_
#define WEEX_UIKIT_PLATFORM_LENGTH_H_
...
class PLATFORM_EXPORT Length {
 ...
 public:
  ...
  float getFloatValue() const {
    ASSERT(!isMaxSizeNone());
    return m_isFloat ? m_floatValue : static_cast<float>(m_intValue);
  }
...
#endif  // WEEX_UIKIT_PLATFORM_LENGTH_H_
