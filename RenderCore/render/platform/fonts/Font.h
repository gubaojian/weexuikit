...
#ifndef WEEX_UIKIT_PLATFORM_FONTS_FONT_H_
#define WEEX_UIKIT_PLATFORM_FONTS_FONT_H_
...
#include "render/platform/fonts/TextBlob.h"
#include "render/platform/text/TextDirection.h"
#include "render/platform/text/TextPath.h"
...
class PLATFORM_EXPORT Font {
 ...
 private:
  ...
  TextBlobPtr buildTextBlob(const GlyphBuffer&,
                            ...
                            const FloatRect& bounds, GraphicsContext* context) const;
...
#endif  // WEEX_UIKIT_PLATFORM_FONTS_FONT_H_
