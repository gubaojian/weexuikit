...
#ifndef WEEX_UIKIT_PLATFORM_TEXT_UNICODERANGE_H_
#define WEEX_UIKIT_PLATFORM_TEXT_UNICODERANGE_H_
...
PLATFORM_EXPORT const char* langGroupFromUnicodeRange(
    unsigned char unicodeRange);

}  // namespace blink

#endif  // WEEX_UIKIT_PLATFORM_TEXT_UNICODERANGE_H_
