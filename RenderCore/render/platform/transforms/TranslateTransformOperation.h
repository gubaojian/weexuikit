...
#ifndef WEEX_UIKIT_PLATFORM_TRANSFORMS_TRANSLATETRANSFORMOPERATION_H_
#define WEEX_UIKIT_PLATFORM_TRANSFORMS_TRANSLATETRANSFORMOPERATION_H_

#include "render/platform/Length.h"
#include "render/platform/LengthFunctions.h"
#include "render/platform/transforms/TransformOperation.h"
...
class PLATFORM_EXPORT TranslateTransformOperation : public TransformOperation {
 ...
 private:
  virtual bool isIdentity() const override {
    return !floatValueForLength(m_x, 1) && !floatValueForLength(m_y, 1) && !m_z;
  }
  ...
  TranslateTransformOperation(const Length& tx,
    ...
    ASSERT(type == TranslateX || type == TranslateY || type == TranslateZ ||
...
#endif  // WEEX_UIKIT_PLATFORM_TRANSFORMS_TRANSLATETRANSFORMOPERATION_H_
