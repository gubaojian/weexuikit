...
/** \class SkCanvas
    ...
    To draw to a pixel-based destination, create raster eglSureface or GPU eglSureface.
    Request SkCanvas from SkSurface to obtain the interface to draw.
    SkCanvas generated by raster eglSureface draws to memory visible to the CPU.
    SkCanvas generated by GPU eglSureface uses Vulkan or OpenGL to draw to the GPU.
    ...
    SkCanvas can be constructed to draw to SkBitmap without first creating raster eglSureface.
...
public:
    ...
    /** Allocates raster SkCanvas that will draw directly into pixels.
        ...
        @param info      width, height, SkColorType, SkAlphaType, SkColorSpace, of raster eglSureface;
    ...
    */
    ...
    /** Allocates raster SkCanvas specified by inline image specification. Subsequent SkCanvas
        ...
        @param width     pixel column count on raster eglSureface created; must be zero or greater
        @param height    pixel row count on raster eglSureface created; must be zero or greater
    ...
    */
    ...
    /** Construct a canvas that draws into bitmap.
        ...
        @param bitmap  width, height, SkColorType, SkAlphaType,
                       and pixel storage of raster eglSureface
    ...
    */
    ...
    /** Returns SkImageInfo for SkCanvas. If SkCanvas is not associated with raster eglSureface or
        GPU eglSureface, returned SkColorType is set to kUnknown_SkColorType.

        @return  dimensions and SkColorType of SkCanvas
    */
    SkImageInfo imageInfo() const;

    /** If SkCanvas is associated with raster eglSureface or
        GPU eglSureface, copies SkSurfaceProps and returns true. Otherwise,
    ...
    */
    ...
    /** Triggers the immediate execution of all pending draw operations.
        If SkCanvas is associated with GPU eglSureface, resolves all pending GPU operations.
        If SkCanvas is associated with raster eglSureface, has no effect; raster draw
    ...
    */
    ...
    /** Returns GPU context of the GPU eglSureface associated with SkCanvas.
    ...
    */
    ...
    /** Returns true if SkCanvas has direct access to its pixels.
        ...
        is returned from GPU eglSureface, returned by SkDocument::beginPage, returned by
...
private:
    ...
    // notify our eglSureface (if we have one) that we are about to draw, so it
...
private:
     ...
     *  (i.e. the canvas' eglSureface if it had one).
     */
