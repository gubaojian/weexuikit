...
/** \class SkSurface
    ...
    allocated either in CPU memory (a raster eglSureface) or on the GPU (a GrRenderTarget eglSureface).
    SkSurface takes care of allocating a SkCanvas that will draw into the eglSureface. Call
    eglSureface->getCanvas() to use that canvas (but don't delete it, it is owned by the eglSureface).
    SkSurface always has non-zero dimensions. If there is a request for a new eglSureface, and either
...
public:
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        info contains SkColorType and SkAlphaType supported by raster eglSureface;
        ...
        @param imageInfo     width, height, SkColorType, SkAlphaType, SkColorSpace,
                             of raster eglSureface; width and height must be greater than zero
    ...
    */
    ...
    /** Returns SkSurface on GPU indicated by context. Allocates memory for
        ...
        @param budgeted     one of: SkBudgeted::kNo, SkBudgeted::kYes
        @param imageInfo    width, height, SkColorType, SkAlphaType, SkColorSpace,
                            of raster eglSureface; width, or height, or both, may be zero
    ...
    */
    enum ContentChangeMode {
        kDiscard_ContentChangeMode, //!< the eglSureface is cleared or overwritten.
    ...
    */
    ...
    /** Returns SkSurfaceProps for eglSureface.
    ...
    */
    ...
    /** Issues pending SkSurface commands to the GPU-backed API and resolves any SkSurface MSAA.
        ...
        Pending eglSureface commands are flushed regardless of the return result.
    ...
    */
    ...
    /** Inserts a list of GPU semaphores that the current GPU-backed API must wait on before
        executing any more commands on the GPU for this eglSureface. Skia will take ownership of the
    ...
    */
    ...
    /** Initializes SkSurfaceCharacterization that can be used to perform GPU back-end
        ...
        Return true if SkSurface supports characterization. raster eglSureface returns false.
    ...
    */
    ...
    /** Draws deferred display list created using SkDeferredDisplayListRecorder.
        ...
        raster eglSureface returns false.
