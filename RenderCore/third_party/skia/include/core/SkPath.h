...
public:
    ...
    */
    ...
    /** \enum SkPath::Convexity
        ...
        may have better performance and require fewer resources on GPU eglSureface.
    ...
    */
    ...
    /** Specify whether SkPath is volatile; whether it will be altered or discarded
        ...
        raster eglSureface SkPath draws are affected by volatile for some shadows.
        GPU eglSureface SkPath draws are affected by volatile for some shadows and concave geometries.
