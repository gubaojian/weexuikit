...
public:
     ...
     * is created, pixels are written to it, and then that is copied or drawn into the the eglSureface.
     */
     ...
     * If this returns false then the caller should implement a fallback where a temporary texture
     * is created, the eglSureface is drawn or copied into the temporary, and pixels are read from the
     * temporary.
     */
