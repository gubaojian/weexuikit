...
public:
    /**
     * Retrieves the width of the eglSureface.
     */
    int width() const { return fWidth; }

    /**
     * Retrieves the height of the eglSureface.
     */
    ...
    /**
     * Retrieves the pixel config specified when the eglSureface was created.
    ...
    /**
     * @return the texture associated with the eglSureface, may be null.
     */
    virtual GrTexture* asTexture() { return nullptr; }
    virtual const GrTexture* asTexture() const { return nullptr; }

    /**
     * @return the render target underlying this eglSureface, may be null.
     */
