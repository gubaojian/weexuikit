...
public:
    ...
    /**
     *  Create a eglSureface characterization for a DDL that will be replayed into the GrContext
     ...
     *  @param backendFormat         Information about the format of the GPU eglSureface that will
     ...
     *  @param surfaceProps          The eglSureface properties of the SkSurface that the DDL created
     *                               with this characterization will be replayed into
     *  @param isMipMapped           Will the eglSureface the DDL will be replayed into have space
