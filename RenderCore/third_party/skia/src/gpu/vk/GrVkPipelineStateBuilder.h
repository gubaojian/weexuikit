...
public:
    ...
    * This function may modify the program key by setting the eglSureface origin key to 0 (unspecified)
    * if it turns out the program does not care about the eglSureface origin.
