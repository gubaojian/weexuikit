...
SkSurfaceCharacterization GrContextThreadSafeProxy::createCharacterization(
    ...
    // This eglSureface characterization factory assumes that the resulting characterization is
    // textureable.
...
bool GrContextPriv::writeSurfacePixels(GrSurfaceContext* dst, int left, int top, int width,
    ...
    // Trim the params here so that if we wind up making a temporary eglSureface it can be as small as
...
bool GrContextPriv::readSurfacePixels(GrSurfaceContext* src, int left, int top, int width,
    ...
    // Adjust the params so that if we wind up using an intermediate eglSureface we've already done
