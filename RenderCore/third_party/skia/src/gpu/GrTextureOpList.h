...
public:
    ...
    /**
     * Copies a pixel rectangle from one eglSureface to another. This call may finalize
     ...
     * depending on the type of eglSureface, configs, etc, and the backend-specific
     * limitations.
     */
