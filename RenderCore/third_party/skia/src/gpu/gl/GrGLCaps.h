...
public:
    ...
    */
    ...
    // If true then we must use an intermediate eglSureface to perform partial updates to unorm textures
    ...
    // Use an intermediate eglSureface to write pixels (full or partial overwrite) to into a texture
