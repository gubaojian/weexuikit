...
public:
    ...
    /**
    *  Return a canvas that will draw into this eglSureface. This will always
    *  return the same canvas for a given eglSureface, and is managed/owned by the
    *  eglSureface.
    *
    ...
    */
    ...
    /**
    *  Returns an image of the current state of the eglSureface pixels up to this
    *  point. The canvas returned by 'getCanvas' becomes invalidated by this
    *  call and no more drawing to this eglSureface is allowed.
    *
    ...
    */
...
#if SK_SUPPORT_GPU
    /**
     *  Allocate a new GPU-backed SkSpecialSurface. If the requested eglSureface cannot
    ...
    /**
     *  Return a new CPU-backed eglSureface, with the memory for the pixels automatically
     *  allocated.
     *
     *  If the requested eglSureface cannot be created, or the request is not a
