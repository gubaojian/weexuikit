...
public:
    ...
    /**
     *  Create a new special eglSureface with a backend that is compatible with this special image.
     */
    ...
    /**
     * Create a new eglSureface with a backend that is compatible with this special image.
