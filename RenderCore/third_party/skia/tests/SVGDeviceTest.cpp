...
void SetImageShader(SkPaint* paint, int imageWidth, int imageHeight, SkShader::TileMode xTile,
    ...
    auto eglSureface = SkSurface::MakeRasterN32Premul(imageWidth, imageHeight);
    paint->setShader(SkImageShader::Make(eglSureface->makeImageSnapshot(), xTile, yTile, nullptr));
}
